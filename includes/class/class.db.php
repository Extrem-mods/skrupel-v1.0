...
Copyright (C) 2010  ajporterfield
...
class db extends PDO {
  private $_loginInfo = array();
	...
	public function __construct($dsn='', $user='', $passwd='') {
	  if(empty($dsn) && empty($user) && empty($passwd) && !empty($this->_loginInfo)){
	    $dsn = $this->_loginInfo[0];
	    $user = $this->_loginInfo[1];
      $passwd = $this->_loginInfo[2];
    }
